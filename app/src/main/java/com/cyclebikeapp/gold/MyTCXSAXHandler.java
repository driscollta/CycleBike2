...
**/
	...
	public void startDocument() {
		...
		//Log.v("CycleBike", " - TCXSAXHandler starting to parse file");
	}

	@Override
	public void endDocument() {
		//Log.v("CycleBike", " - TCXSAXHandler finished parsing file");
		summarizing = false;
	}
	...
	public void startElement(String uri, String name, String qName, Attributes atts) throws NumberFormatException {
		...
		case 1:
			if (tagName.equals(lvl2TimeTagNameUF)
				...
				tagLevel = 2;
				summarizing  = true;
//				Log.i("CycleBike",  "lvl 2 summary tags - " + tagName);
			}
			break;
		...
		case 2:
			if (tagName.equals(lvl3LatitudeTagNameSC)
				...
				tagLevel = 3;
				summarizing  = true;
//				Log.i("CycleBike",  "lvl 3 summary tags - " + tagName);
			}
			break;
...
//					 Log.i("CycleBike", "avgCadence: " + buff.toString());
						avgCadence = Integer.valueOf(buff.toString()).floatValue();
						tagLevel = 0;
						clearBuff();
						break;
					case lvl1SumAvgWattsTagName:
//					Log.i("CycleBike", "avgWatts: " + buff.toString());
                        float avgPower = Integer.valueOf(buff.toString()).floatValue();
						tagLevel = 0;
						clearBuff();
						break;
...
//					 Log.i("CycleBike", "avgHeartRate: " + buff.toString());
...
//					Log.i("CycleBike", "maxHeartRate: " + buff.toString());
...
//		Log.d("CycleBike" + "TCXSAX", "endTag: " + tagName + " tagLevel: " + tagLevel);
		switch (tagLevel) {
		case 0:
			if (tagName.equals(lvl0LapTagName)) {
				tagLevel = -1;
...
//			Log.i("CycleBike", "added RecordMesg - " + handlersRecordMesgs.size());
			clearBuff();
			break;
		case 2:
			switch (tagName) {
...
//			     Log.i("CycleBike", "UF " + buff.toString());
//			     Log.i("CycleBike", "ufDateTime: " + uf.getDate().toString());
...
//				 Log.i("CycleBike", "HeartRate: " + buff.toString());
				tagLevel = 2;
				clearBuff();
